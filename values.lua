...
FIRST_LINE_SPEED = 40                           --кубики

--FAST_LINE_SPEED = 60
LINE_SPEED = 40 + 5 - 5 + 5 - 5
...
ROUTER_BACK_SPEED = 25 + 10 - 10                     --отъезд
--ROUTER_GET_SPEED = 10
...
-- Shake
SHAKE_SPEED = 10 + 5
FORWARD_SHAKE_DEGREES = 50 - 10 + 5 + 3
SIDE_SHAKE_DEGREES = 30 - 5 + 5

-- Finish
FINISH_DEGREES_ROTATE = 40 + 8
FINISH_DEGREES = 600 + 100
